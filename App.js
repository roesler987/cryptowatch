...
import { Picker } from '@react-native-picker/picker'; //para criar listas suspensas
import * as Location from 'expo-location';
import * as Calendar from 'expo-calendar';
import DateTimePickerModal from 'react-native-modal-datetime-picker'; // para escolher dara e hora
import useWebSocket from 'react-use-websocket';// funcionalidades websockte em componentes react
...
const App = () => {
  ...
  <View style={styles.content}>
    ...
    {/* componente que permite selecionar uma criptomoeda*/ }
      <Picker // atualiza o estado com o valor selecionado
